            ...
            {{-- @if ($categories->count()) --}}<tr>
                ...
                @forelse ($categories as $cat)
                    ...
                    <td>
                            ...
                            <form action="{{ route('dashboard.categories.restore', ['category' => $cat->id]) }} " method="post">
                                @csrf
                                @method('put')
                    ...
                    <td>
                        <form action="{{ route('dashboard.categories.force_delete', ['category' => $cat->id]) }} " method="post">
                            @csrf
                            @method('delete')
